...
import visdom
import data
from HyperComm import HyperComm
from utils import *
from action_utils import parse_action_args
from trainer_smac import SMACTrainer as Trainer
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='HyperComm: Multi agent communication on Hypergraph')
    ...
    parser.add_argument('--qk_hid_size', default=128, type=int,
                    help='query and key size')
    ...
    # environment
    parser.add_argument('--env_name', default="smac",
                        help='name of the environment to run')
    
    parser.add_argument('--map_name', default="8m",
                        help='smac map')
    ...
    args.nagents = env.env_info['n_agents']
